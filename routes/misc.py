...
def api_profile_get():
    ...
    try:
        ...
        return jsonify({"profile": {
            ...
            "autoGenerateDocs": "true" if settings.get("auto_generate_docs") else "",
            "autoIncludeAct": "true" if settings.get("auto_include_act", True) else "",
            "autoIncludeM15": "true" if settings.get("auto_include_m15", True) else "",
            "autoIncludeYandex": "true" if settings.get("auto_include_yandex", True) else "",
            "yandexSyncData": "true" if settings.get("yandex_sync_data", True) else "",
...
def api_profile_post():
    ...
    try:
        ...
        auto_generate_docs = profile.get('autoGenerateDocs') == 'true'
        ...
        save_user_settings(username, notify_only_mine, my_task_keywords,
                           ...
                           auto_generate_docs=auto_generate_docs,
                           auto_include_act=auto_include_act,
                           auto_include_m15=auto_include_m15,
                           auto_include_yandex=auto_include_yandex,
                           yandex_sync_data=yandex_sync_data)
