...
def api_profile_get():
    ...
    try:
        ...
        return jsonify({"profile": {
            ...
            "defaultDepartment": settings.get("default_department", ""),
        }})
...
def api_profile_post():
    ...
    try:
        ...
        if 'defaultDepartment' in profile:
            default_department = str(profile.get('defaultDepartment', '') or '').strip()
        else:
            default_department = (existing or {}).get('default_department', '')
